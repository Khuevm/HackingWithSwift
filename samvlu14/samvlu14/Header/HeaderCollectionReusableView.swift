...
class HeaderCollectionReusableView: UICollectionReusableView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @objc private func changeImage(){
        if currentIndex < collectionView.numberOfItems(inSection: 0) - 1 {
            currentIndex += 1
        } else {
            currentIndex = 0
        }
